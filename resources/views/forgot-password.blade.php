...
<html>
<head>
    <title>Forgot Password — Daily Finance</title>
...
<body class="flex items-center justify-center h-screen" style="background: linear-gradient(135deg, #f0f4ff 0%, #fdf4ff 100%);">
    ...
    <div class="p-8 bg-white rounded-2xl shadow-xl text-center max-w-sm w-full mx-4 border border-gray-100">
        ...
        <h2 class="mb-1 text-2xl font-bold text-gray-900">Reset Password</h2>
        <p class="mb-6 text-sm text-gray-400">Enter your username and new password</p>
        ...
        <form action="/forgot-password" method="POST">
            ...
            <input type="text" name="username" placeholder="Username" value="{{ old('username') }}" required
                   ...
                   autofocus>
            @error('username')
                <p class="text-red-500 text-sm text-left mb-3">{{ $message }}</p>
            @enderror
